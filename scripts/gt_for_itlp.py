...
class GTBroadcaster:
    def __init__(self):
        ...
        tx, ty, tz = self.gt_poses[0, :3]
        qx, qy, qz, qw = self.gt_poses[0, 3:]
        self.tf_map_to_reper = TransformStamped()
        self.tf_map_to_reper.header.stamp = self.gt_stamps[0]
        ...
        self.tf_reper_to_odom.header.stamp = self.gt_stamps[0]
        self.tf_reper_to_odom.header.frame_id = 'reper'
        self.tf_reper_to_odom.child_frame_id = 'robot/odom'
